...
from libs.generic.patterns.dag_ingestion_api_patterns import (
    DagIngestionAPIPatterns as DagPatterns,
)
...
for table in dag_patterns.cfg_ingestion:
    ingestion_raw = dag_patterns.raw_update_table(
        ...
        cfg_table=table,
        platform_project_id=INFO_DAG["DATA_PLATFORM_PROJECT_ID"],
