# ======================================================================== #
#   This module is deprecated. Please use ../data_quality/expectation.py   #
# ======================================================================== #
...
class Expectation:
    ...
    @classmethod
    def df_expectation(
        cls, spark_session: SparkSession, data: List[Dict], execution_id: str
    ) -> DataFrame:
        return spark_session.createDataFrame(
            data=[Row(cod_execucao=execution_id, **row) for row in data],
            schema=StructType(
                [
                    StructField(column, struct["STRUCT_TYPE"], struct["NULLABLE"])
