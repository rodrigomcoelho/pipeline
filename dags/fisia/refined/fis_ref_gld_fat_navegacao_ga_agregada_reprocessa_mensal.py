...
LAYER = "REFINED"
DAG_NAME = "fis_ref_gld_fat_navegacao_ga_agregada_reprocessa_mensal"
TAGS = ["AE", "FIS", "REFINED", "GA", "NAVEGACAO", "REPROCESSAMENTO"]
SCHEDULE_INTERVAL = "0 3 * * *"

# Variaveis para o SQL
CAMADA = Variable.get("GCP_LAYER_FIS_AE")
# timezone = pytz.timezone('America/Sao_Paulo')
# PERIODO = (datetime.utcnow().astimezone(timezone).date() - timedelta(1)).strftime('%Y-%m-%d').replace('-','')
...
dag = DAG(
    ...
    max_active_runs=1,
    start_date=datetime(2022, 11, 16, 0, 0),
